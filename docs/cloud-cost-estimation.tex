...
sheLLaMa provides a zero-cost way to answer this question:
...
\begin{lstlisting}[language=json,caption={API key with budget limit}]
{
  "api_keys": {
    "sk-team-dev": {
      "name": "dev-team",
...
\begin{lstlisting}[language=json,caption={backends.json for multi-server deployment}]
{
  "backends": [
